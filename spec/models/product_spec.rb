...
RSpec.describe Product, type: :model do
  ...
  describe ".above_or_equal_to_price" do
    ...
    it "returns the products wich are above or equal to the price" do
  ...
  describe ".bellow_or_equal_to_price" do
    ...
    it "returns the products wich are bellow or equal to the price" do
      expect(Product.bellow_or_equal_to_price(99).sort).to match_array([@product2,@product4])
    end
  end
