...
RSpec.describe Api::V1::ProductsController, type: :controller do
  ...
  describe "POST #create" do
    context "when is successfully created" do
      before(:each) do
        ...
        post :create, params: { user_id: user.id, product: @product_attributes }, format: :json
      end
    ...
    context "when is successfully" do
      before(:each) do
        patch :update, params: { user_id: @user.id, id: @product.id,
               product: { title: "An expensive TV" } }, format: :json
      end
  ...
  describe "DELETE #destroy" do
  	before(:each) do
  	  ...
  	  @product =  FactoryGirl.create :product, user: @user
  	  api_authorization_header @user.auth_token
  	  delete :destroy, params: { user_id: @user.id, id: @product.id }, format: :json
  	end
